...
(async function main() {
  try {
    ...
    try {
      ...
      console.log(
        `  Developer Wallet: ${globalInfoAccount.developerWallet.toBase58()}`,
      );
      console.log(
        `  Founder Wallet: ${globalInfoAccount.founderWallet.toBase58()}`,
      );
      console.log(`  Fee Percentage: ${globalInfoAccount.feePercentage}`);
      console.log(
        `  Fee Percentage Divider: ${globalInfoAccount.feePercentageDivider}`,
      );
      console.log(
        `  Min Fee for Distribution: ${globalInfoAccount.minFeeForDistribution}`,
      );
      console.log(`  Min Fee: ${globalInfoAccount.minFee}`);
      console.log(
        `  Developer Fee Share: ${globalInfoAccount.developerFeeShare}%`,
      );
      ...
      console.warn(
        "👉 Run `npx ts-node initializeProgram.ts` to initialize it.",
      );
    }
    console.log("==========================================");
  } catch (e: any) {
